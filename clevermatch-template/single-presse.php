<?php
/**
 * The Template for displaying all single posts in category 'presse'.
 */
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="text-center my-5">
		<a href="<?php echo esc_url( home_url() ); ?>/clevermatch/presse/" class="btn btn-info">Alle Veröffentlichungen anzeigen</a>
	</div>
</article>
<?php
		endwhile;
